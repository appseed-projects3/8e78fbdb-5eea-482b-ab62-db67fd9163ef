...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-17 19:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8e78fbdb-5eea-482b-ab62-db67fd9163ef.git
$ cd 8e78fbdb-5eea-482b-ab62-db67fd9163ef
```
